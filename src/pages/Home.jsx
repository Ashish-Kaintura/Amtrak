      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center max-w-7xl mx-auto mt-12">
        <div>
          ...
          <div className="flex gap-4">
            <a href="/results" className="px-8 py-4 bg-amber-600 hover:bg-amber-700 text-white rounded-full font-semibold transition-colors flex items-center gap-2 shadow-lg shadow-amber-600/30">
              Search Tickets
